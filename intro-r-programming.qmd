...
:::{#exercise-1 .callout-note icon=false}
...
### Functions and their arguments {#calling-functions}
...
:::{#exercise-2 .callout-note icon=false}
...
a.  Create a vector `height_mm` that contains the following heights of animals 100,150,99,87 in mm respectively.

b.  What is the total height of these animals in mm? (*Hint*: use function `sum`)


c.  Another animal was measured and its height is 220mm. Add this to the beginning of the vector `height_mm` and save the total height of the new set of animals in the `total_height` variable. What is the new total_height?
...
:::{#exercise-3 .callout-note icon=false}

## Exercise 3 {#exercise-3}
Level:  ![](images/stars-level-1.png)

a.  Using this vector of heights in inches, create a new vector, `heights_no_na`, with the NAs removed.
...
b.  Use the function `median()` to calculate the median of the `heights` vector.

c.  How many people in the set are taller than 67 inches.
